%% Plot the path loss model and the histogram of the Gaussian Mixture Model
...
n = random(gm,length(d));%Noise with GMM distribution
RSS=P+n;%Received Signal Strength
